...
void main(void)
{
	/*vec3 temp = rgb2hsv(aColor.rgb).xyz;
	temp = temp + vec3(0.0, gl_PrimitiveID * 0.01, gl_PrimitiveID * 0.01);
	temp = hsv2rgb(temp);
	temp.xyz = mod(vec3(0.0, 100.0 - (gl_PrimitiveID * 2), 100.0 - (gl_PrimitiveID * 5)), 1.0);
